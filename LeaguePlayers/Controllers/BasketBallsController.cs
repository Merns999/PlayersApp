...
namespace LeaguePlayers.Controllers
{
    ...
    [ApiController]
    public class BasketBallsController : MyDbController<BasketBall, EfCoreBasketBallRepository>
    {
        public BasketBallsController(EfCoreBasketBallRepository repository) : base(repository)
        {
